const hasDirectIndex = ({ children }) => children.some((child) => (
    child.type === 'file' && child.name === 'index.json'
));

const hasRemoteIndex = ({ children }) => children.some((child) => (
    child.type === 'dir' && hasIndex(child)
));
